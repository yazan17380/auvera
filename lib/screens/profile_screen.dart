      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Text('Profile', style: Theme.of(context).textTheme.headlineMedium?.copyWith(fontSize: 20)),
              ...
              Container(
                ...
                child: Row(children: [
                  ...
                  const Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text('Yazan Khalifa', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: AppColors.textPrimary)),
                    SizedBox(height: 4),
                    Text('yazan@email.com', style: TextStyle(fontSize: 12.5, color: AppColors.textSecondary)),
                  ])),
                  GestureDetector(
              ...
              const SizedBox(height: 24),
              _ProfileMenuItem(icon: Icons.receipt_long_outlined, label: 'My Orders',
                  onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => const MyOrdersScreen()))),
              _ProfileMenuItem(icon: Icons.favorite_border_rounded, label: 'My Wishlist', onTap: () {}),
              _ProfileMenuItem(icon: Icons.lock_outline_rounded, label: 'Change Password', onTap: () {}),
              const SizedBox(height: 12),
              const Divider(color: AppColors.border),
              const SizedBox(height: 12),
              _ProfileMenuItem(icon: Icons.logout_rounded, label: 'Logout', isDestructive: true,
  ...
  void _handleLogout(BuildContext context) {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: const Text('Are you sure you want to logout?', style: TextStyle(fontSize: 13, color: AppColors.textSecondary)),
        actions: [
          ...
          TextButton(
            ...
            child: const Text('Logout', style: TextStyle(color: AppColors.error, fontWeight: FontWeight.w700)),
          ),
        ],
      ),
    );
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(children: [
          ...
          if (!isDestructive) const Icon(Icons.chevron_right_rounded, size: 20, color: AppColors.textHint),
        ]),
      ),
    );
  }
